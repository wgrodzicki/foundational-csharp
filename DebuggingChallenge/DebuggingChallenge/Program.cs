...
while (transactions > 0)
{
    ...
    Console.WriteLine(TillAmountSummary(cashTill));
    Console.WriteLine($"Expected till value: {registerCheckTillTotal}");
    Console.WriteLine($"Transaction #{transactionCounter}");
    Console.WriteLine();
}
...
static void MakeChange(int cost, int[] cashTill, int twenties, int tens = 0, int fives = 0, int ones = 0)
{
    ...
    if (changeNeeded < 0)
    {
        RejectTransaction(cashTill, twenties, tens, fives, ones);
    ...
    {
        RejectTransaction(cashTill, twenties, tens, fives, ones);
        RevertTransaction(cashTill, changeTwenties, changeTens, changeFives, changeOnes);
...
/// <summary>
/// Rejects the transaction and gives the money back to the customer
/// </summary>
/// <param name="cashTill"></param>
/// <param name="twenties"></param>
/// <param name="tens"></param>
/// <param name="fives"></param>
/// <param name="ones"></param>
static void RejectTransaction(int[] cashTill, int twenties, int tens, int fives, int ones)
{
    cashTill[3] -= twenties;
    cashTill[2] -= tens;
    cashTill[1] -= fives;
...
/// <summary>
/// Reverts every change made during the transaction
/// </summary>
/// <param name="cashTill"></param>
/// <param name="changeTwenties"></param>
/// <param name="changeTens"></param>
/// <param name="changeFives"></param>
/// <param name="changeOnes"></param>
static void RevertTransaction(int[] cashTill, int changeTwenties, int changeTens, int changeFives, int changeOnes)
{
    for (int i = 0; i < changeTwenties; i++)
    {
        cashTill[3]++;
    }

    for (int i = 0; i < changeTens; i++)
    {
        cashTill[2]++;
    }

    for (int i = 0; i < changeFives; i++)
    {
        cashTill[1]++;
    }

    for (int i = 0; i < changeOnes; i++)
    {
        cashTill[0]++;
    }
}